...
export default function AiInterviewCoach() {
    ...
    const beginNow = async () => {
        ...
        const first = [
            {
                role: "user",
                content: `Start the interview. Ask question 1 of ${config.qCount}.`,
            },
        ];
    ...
    const submitAnswer = async () => {
        ...
        if (isLast) {
            setReport({
                ...
                overall: Math.round(
                    Object.values(parsed?.scores || scores).reduce((a, b) => a + b, 0) /
                    4,
                ),
                readiness: "Good",
            });
            ...
            <div className={styles.mainDiv}>
                ...
                <div className={styles.topBar}>
                    <div className={styles.logoSection}>
                        ...
                        <span className={styles.logoText}>AI Interview Coach</span>
                    </div>
                    <div className={styles.topRight}>
                        ...
                        <div
                            ...
                            style={{
                                background: camOn ? "var(--green)" : "var(--muted)",
                            }}
                        >
                ...
                <div style={{ flex: 1, overflow: "hidden", display: "flex" }}>
                    ...
                    {(phase === "setup" || phase === "ready") && (
                        <div className={styles.setupPhase}>
                            ...
                            <div className={styles.sidebar}>
                                <p className={styles.sidebarTitle}>Interview Settings</p>
                                {/* Target Role */}
                                {[
                                    {
                                        label: "Target Role",
                                    ...
                                    <div className={styles.questionButtons}>
                                        {Q_CNT.map((n) => (
                                            <button
                                                ...
                                                className={`${styles.questionButton} ${config.qCount === n ? styles.activeQuestion : ""
                                                    }`}
                                            >
                                                {n}Q
                                            </button>
                                ...
                                {/* Start Interview */}
                                <button onClick={startInterview} className={styles.startButton}>
                                    🎯 Start Mock Interview
                                </button>
                                {/* Information Card */}
                                <div className={styles.infoCard}>
                                    <p className={styles.infoText}>
                                        <span className={styles.infoHeading}>💡 How it works:</span>
                                        AI asks one question at a time. Answer via text or voice,
                                        get real-time feedback on clarity, depth, and delivery.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className={styles.rightPanel}>
                                {phase === "setup" ? (
                                    <div className={`${styles.setupContainer} fadeUp`}>
                                        ...
                                        <h2 className={styles.setupTitle}>Your AI Interviewer</h2>
                                        <p className={styles.setupDescription}>
                                            Configure your interview on the left, then start your
                                            session. The AI will ask professional questions and give
                                        ...
                                        <div className={styles.welcomeCard}>
                                            ...
                                            <div className={styles.badgeContainer}>
                                                {[
                                                    ...
                                                    <span key={t} className={styles.infoBadge}>
                                                        {t}
                                                    </span>
                                                ))}
                                            </div>
                                        </div>
                                        <button onClick={beginNow} className={styles.beginButton}>
                                            ▶ Begin Interview
                                        </button>
                                    </div>
                                )}
                    ...
                    {phase === "interview" && (
                        <div className={styles.mainContainer}>
                            ...
                            <div className={styles.sidebar}>
                                ...
                                <div className={styles.sidebarSection}>
                                    <div className={styles.webcamBox}>
                                        ...
                                        {!camOn && (
                                            <div className={styles.cameraOverlay}>
                                                <span className={styles.cameraIcon}>🎥</span>
                                                <span className={styles.cameraText}>No Camera</span>
                                            </div>
                                        )}
                                        {camOn && (
                                            <div className={styles.liveBadge}>
                                ...
                                {/* Current Question */}
                                <div className={styles.sidebarSection}>
                                    <p className={styles.sectionTitle}>Current Question</p>
                                ...
                                <div className={styles.scoreSection}>
                                    <p className={styles.sectionTitle}>Live Scores</p>
                                    {SCORE_KEYS.map((k, i) => (
                                        <div key={k} className={styles.scoreItem}>
                                            <div className={styles.scoreHeader}>
                                                <span className={styles.scoreName}>{k}</span>
                                                <span
                                    ...
                                    {feedback.length > 0 && (
                                        <div className={styles.feedbackSection}>
                                            <p className={styles.sectionTitle}>AI Feedback</p>
                                            {feedback.map((f, i) => (
                            ...
                            <div className={styles.chatSection}>
                                ...
                                <div ref={chatRef} className={styles.chatContainer}>
                                    {messages.map((m, i) => (
                                        <div
                                            key={i}
                                            className={`fadeUp ${styles.messageRow} ${m.role === "user" ? styles.userRow : styles.assistantRow
                                                }`}
                                        >
                                            {m.role === "assistant" && (
                                ...
                                <div className={styles.answerSection}>
                                    ...
                                    <p className={styles.answerHint}>
                                        Press Ctrl+Enter to submit · 🎤 for voice · Question {qIdx}{" "}
                                        of {config.qCount}
                                    </p>
                                </div>
                            </div>
                    ...
                    {phase === "report" && report && (
                        <div className={styles.reportContainer}>
                            <div className={`${styles.reportContent} fadeUp`}>
                                {/* ================= Report Header ================= */}

                                <div className={styles.reportHeader}>
                                    <div className={styles.trophyIcon}>🏆</div>

                                    <h2 className={styles.reportTitle}>Interview Complete!</h2>
                                ...
                                <div className={styles.scoreBreakdownCard}>
                                    ...
                                    {SCORE_KEYS.concat(["Problem Solving"]).map((k, i) => {
                                        const val =
                                            report.scores[k] || Math.round(75 + Math.random() * 18);
